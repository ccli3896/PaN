...
def main():
  ...
  # Set filename
  fname = f"landscape_switchingpeaks_s{s}.pkl"
  ...
  for t in range(timesteps):
    ...
    # Every [switch_interval] timesteps, change the landscape
    if t%switch_interval == 0:
      gp_index = (gp_index+1) % 2
      landscape = gps[gp_index]
